...
async function queryGPUVRAMUsage() {
  ...
  const csharpCode = [
    ...
    '                            {',
    '                                // IDXGIAdapter3 vtable: slot 14 = QueryVideoMemoryInfo',
    '                                // (0-2 IUnknown, 3-6 IDXGIObject, 7-9 IDXGIAdapter,',
    '                                //  10 IDXGIAdapter1::GetDesc1, 11 IDXGIAdapter2::GetDesc2,',
    '                                //  12 RegisterHwContentProtectionTeardown, 13 UnregisterHwContentProtectionTeardown,',
    '                                //  14 QueryVideoMemoryInfo)',
    '                                IntPtr a3vtbl = Marshal.ReadIntPtr(adapter3Ptr);',
    '                                IntPtr qvmiPtr = Marshal.ReadIntPtr(a3vtbl, IntPtr.Size * 14);',
