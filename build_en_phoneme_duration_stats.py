...
def print_data_source_help():
    print("=" * 60)
    print("Data source preparation instructions")
    print("=" * 60)
    print()
    print("1. Download LJSpeech TextGrid alignment files (~50MB):")
    print("   https://drive.google.com/drive/folders/1DBRkALpPd6FL9gjHMmMEdHODmkgNIIK4")
    print("   Extract to: preprocessed_data/LJSpeech/TextGrid/")
    print()
    print("   Domestic mirror alternative (unofficial): try ghproxy acceleration or search for LJSpeech MFA TextGrid yourself")
    print()
    print("2. Download LJSpeech metadata.csv (wav audio not required):")
    print("   https://keithito.com/LJ-Speech-Dataset/")
    print("   Place at: raw_data/LJSpeech/metadata.csv")
    print()
    print("3. Download librispeech-lexicon.txt:")
    print("   https://github.com/ming024/FastSpeech2/raw/master/lexicon/librispeech-lexicon.txt")
    print("   Place at: lexicon/librispeech-lexicon.txt")
    print()
    print("4. (Optional) Install praatio to improve parsing robustness:")
