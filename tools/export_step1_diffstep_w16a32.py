...
def main():
    ...
    parser.add_argument('--output-dir', default=os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'onnx_models', 'fp16'))
    ...
    model_path = args.model_path or os.path.join(
        os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'SoulX-Singer', 'pretrained_models', 'SoulX-Singer', 'model.pt')
